<template>
	<div class="system-user-dialog-container">
		<el-dialog title="编辑用户" v-model="state.dialog.isShowDialog" width="769px" @close="closeDialog">
			<el-form ref="dataFormRef" :model="state.dataForm" :rules="state.rules" size="default" label-width="90px">
				<el-row :gutter="35">
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="账户名称" prop="username">
							<el-input v-model="state.dataForm.username" placeholder="请输入账号名称" disabled
							clearable></el-input>
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						...
						<el-select v-model="state.dataForm.roles" multiple collapse-tags collapse-tags-tooltip
...
const onSubmit = () => {
	dataFormRef.value.validate(async (valid: boolean) => {
        ...
        userApi.userupdate(props.uid,state.dataForm).then(() => {
